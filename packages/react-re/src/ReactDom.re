...
external reactCreateElement :
  (string, ~props: props=?, array(React.Element.t)) =>
  React.Element.t =
  "createElement";
...
let createElement =
    (name: string, ~props: props, children: array(React.Element.t))
    : React.Element.t =>
  reactCreateElement(name, ~props, children);

let div = (~props=defaultProps, ~children=[||], ()) =>
  createElement("div", ~props, children);

let button = (~props=defaultProps, ~children=[||], ()) =>
