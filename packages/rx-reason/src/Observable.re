...
let create6 = ObservableSource.create6;
let create7 = ObservableSource.create7;
...
let pipe5 = ObservableSource.pipe5;
let pipe6 = ObservableSource.pipe6;
let pipe7 = ObservableSource.pipe7;
